				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="<?php echo base_url()."index.php/C_user/userlogin" ?>"><i class="fa fa-lock"></i> Login</a></li>
							</ul>
						</div>
					</div>
				</div>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="<?php echo base_url().'/uploads/produk/'.$x['produk_image']; ?>" alt="" />
										<h2><?php echo 'Rp '.number_format($x['produk_harga'],0,',','.'); ?></h2>
										<p><?= $x['produk_nama'] ?></p>
